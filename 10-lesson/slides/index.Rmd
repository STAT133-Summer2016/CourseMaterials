...
```{r, echo = F}
df <- gather(data = df, key = Treatment, value = Blood_Pressure, A, B)
df
```
```{r}
...
In order to create the ranking data by week, we'll need some tools for time data.  We'll see how to deal with the time data tomorrow!
---
